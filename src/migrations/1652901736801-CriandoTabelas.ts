...
export class CriandoTabelas1652901736801 implements MigrationInterface {
  name = "CriandoTabelas1652901736801";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "pedidos" ("id" bigint NOT NULL, "jogos_id" character varying(128) NOT NULL, "console_id" character varying(128) NOT NULL, "jogoId" uuid, "consoleId" uuid, CONSTRAINT "UQ_bf1294d0c8fcdc0a04d24939e40" UNIQUE ("jogos_id"), CONSTRAINT "UQ_6bc0deffcf546622c88345c7909" UNIQUE ("console_id"), CONSTRAINT "REL_3ae02460fff7022ad1b7aa8d02" UNIQUE ("jogoId"), CONSTRAINT "REL_03ee4654b5088c47ade789f502" UNIQUE ("consoleId"), CONSTRAINT "PK_ebb5680ed29a24efdc586846725" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "carrinhos" ("id" bigint NOT NULL, "usuario_id" character varying(128) NOT NULL, "pedido_id" character varying(128) NOT NULL, "usuarioId" uuid, CONSTRAINT "REL_ff45b69dce2f1ce3032c0a41f8" UNIQUE ("usuarioId"), CONSTRAINT "PK_8ed80828de93327d4601c21c30f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "enderecos" ("id" bigint NOT NULL, "cidade" character varying(128) NOT NULL, "estado" character varying(2) NOT NULL, "cep" character varying(9) NOT NULL, "rua" character varying(50) NOT NULL, "numero" character varying(7) NOT NULL, "bairro" character varying(128) NOT NULL, "complemento" character varying(100) NOT NULL, "usuario_id" character varying(128) NOT NULL, "usuarioId" uuid, CONSTRAINT "UQ_702a2d47c2a196c1c8596dbf2b5" UNIQUE ("usuario_id"), CONSTRAINT "REL_3fda1857bc40b2c12b9562101a" UNIQUE ("usuarioId"), CONSTRAINT "PK_208b05002dcdf7bfbad378dcac1" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `ALTER TABLE "pedidos" ADD CONSTRAINT "FK_3ae02460fff7022ad1b7aa8d021" FOREIGN KEY ("jogoId") REFERENCES "jogos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "pedidos" ADD CONSTRAINT "FK_03ee4654b5088c47ade789f5029" FOREIGN KEY ("consoleId") REFERENCES "consoles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "pedidos" DROP CONSTRAINT "FK_03ee4654b5088c47ade789f5029"`
    );
    await queryRunner.query(
      `ALTER TABLE "pedidos" DROP CONSTRAINT "FK_3ae02460fff7022ad1b7aa8d021"`
    );
